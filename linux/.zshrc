...
_exists 'git' && alias 'g'='git' && alias 'gitpersonal'='git config --local user.email "16730571+PotatoMaster101@users.noreply.github.com"; git config --local user.name "PotatoMaster101"; git config --local user.signingKey "~/.ssh/keys/id_ed25519_github_sign.pub"'
