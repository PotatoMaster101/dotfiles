...
if (Get-Command 'git' -ErrorAction Ignore) { Set-Alias 'g' 'git'; function gitpersonal { git config --local user.email '16730571+PotatoMaster101@users.noreply.github.com'; git config --local user.name 'PotatoMaster101'; git config --local user.signingKey "~/.ssh/keys/id_ed25519_github_sign.pub" } }
