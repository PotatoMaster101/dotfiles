...
load_keys() {
  [ -f "$HOME/.ssh/keys/id_ed25519_github_auth" ] && ssh-add "$HOME/.ssh/keys/id_ed25519_github_auth"
  [ -f "$HOME/.ssh/keys/id_ed25519_github_sign" ] && ssh-add "$HOME/.ssh/keys/id_ed25519_github_sign"
}
