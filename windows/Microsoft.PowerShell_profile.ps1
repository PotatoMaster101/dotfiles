...
if (Get-Command 'git' -ErrorAction Ignore) { Set-Alias 'g' 'git'; if (Get-Command 'Reset-Git.ps1' -ErrorAction Ignore) { Set-Alias 'gn' 'Reset-Git.ps1' } }
...
function ... { Set-Location '../../' }
function q { if (Get-Command 'Clear-ProgramHistory.ps1' -ErrorAction Ignore) { Clear-ProgramHistory.ps1 } exit }
